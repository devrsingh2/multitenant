...
class CreateTenant extends Command
{
    ...
    protected $description = 'Creates a tenant with the provided name and email address e.g. php artisan tenant:create domain_name password domain_name@example.com';
